...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    ...
    <ul class="NavMenu ">
      ...
      <li class="NavItem"><a id="linkcolor1" class="NavLinks" href="pricing.php">Hostel fees</a></li>
...
<div class="HeroContent">
  ...
  <p class="HeroP">𝔻ℝ 𝕄𝔾ℝ 𝔼𝔻𝕌ℂ𝔸𝕋𝕀𝕆ℕ𝔸𝕃 𝔸ℕ𝔻 ℝ𝔼𝕊𝔼𝔸ℝℂℍ 𝕀ℕ𝕊𝕋𝕀𝕋𝕌𝕋𝔼</p>
...
<div class="FooterWrap">
  <div class="FooterLinksContainer">
    <div class="FooterLinksWrapper">
        <div class="FooterLinkItems">
            ...
            <a href="pricing.php" class="FooterLink">Hostel fees</a>
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">DR MGR UNIVERSITY </p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/MGRUniversityDeemed/" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://twitter.com/mgruniversity?lang=en" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/mgreri/?hl=en" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://www.youtube.com/watch?v=CuQ3j7wTqoY" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
